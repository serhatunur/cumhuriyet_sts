...
class BogaziciDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const BogaziciDash({super.key, this.name = "Guest", this.email = "", this.sube=''});

  @override
  State<BogaziciDash> createState() => _BogaziciDash();
}

class _BogaziciDash extends State<BogaziciDash> {
  @override
