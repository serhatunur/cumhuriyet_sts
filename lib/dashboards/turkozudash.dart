...
class TurkozuDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const TurkozuDash({super.key, this.name = "Guest", this.email = "", this.sube=''});

  @override
  State<TurkozuDash> createState() => _TurkozuDash();
}

class _TurkozuDash extends State<TurkozuDash> {
  @override
