...
class ilkerDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const ilkerDash({super.key, this.name = "Guest", this.email = "", this.sube=''});

  @override
  State<ilkerDash> createState() => _ilkerDash();
}

class _ilkerDash extends State<ilkerDash> {
  @override
