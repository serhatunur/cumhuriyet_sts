...
class TuzlucayirDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const TuzlucayirDash({super.key, this.name = "Guest", this.email = "", this.sube=''});
  @override
  State<TuzlucayirDash> createState() => _TuzlucayirDash();
}

class _TuzlucayirDash extends State<TuzlucayirDash> {
  @override
