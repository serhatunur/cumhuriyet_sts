...
class AkdereDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const AkdereDash({super.key, this.name = "Guest", this.email = "", this.sube=''});

  @override
  State<AkdereDash> createState() => _AkdereDash();
}

class _AkdereDash extends State<AkdereDash> {
  @override
