...
class BayiDash extends StatefulWidget {
  final sube;
  final name;
  final email;
  const BayiDash({super.key, this.name = "Guest", this.email = "", this.sube=''});

  @override
  State<BayiDash> createState() => _BayiDash();
}

class _BayiDash extends State<BayiDash> {
  @override
