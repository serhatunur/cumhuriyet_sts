...
import 'package:cumhuriyet_sts/dashboards/TutorDash.dart';
...
class _TutorSignupState extends State<TutorSignup> {
  ...
  Future signUp() async {
    var url = "http://qrcumhuriyetfirini.online/cumhuriyetserver/auth/tutorregister.php";
    ...
    if (response.statusCode == 200) {
      ...
      if (userData == "ERROR") {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                TutorDash(name: userData["name"], email: userData["email"]),
          ),
        );
        print(userData);
        showDialog(
                ...
                child: Padding(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => userManagementDash()),
                      );
                    },
                  ),
                ),
